      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary-gold/10 text-primary-gold text-[10px] font-black uppercase tracking-[0.2em] animate-pulse">
              Why Partner With Us
            </div>
            ...
            <p className="text-slate-500 font-bold text-sm tracking-widest uppercase italic max-w-lg">
              We leverage cutting-edge technology and strategic NBFC tie-ups to 
              deliver financial solutions that are both accessible and agile.
            </p>

            <div className="space-y-4 pt-4">
               {['RBI Registered NBFC Partner', '98% Customer Satisfaction Rate', 'Paperless Digital Documentation'].map((item, i) => (
