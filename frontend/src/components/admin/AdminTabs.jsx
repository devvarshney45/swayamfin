...
const AdminTabs = () => {
  ...
  return (
    <div className={`flex items-center justify-between border-b ${isDark ? 'border-white/5' : 'border-slate-100'} mb-8 md:mb-10 overflow-x-auto no-scrollbar pb-1 px-1`}>
      ...
      <button 
        ...
        className={`flex items-center gap-2.5 px-6 py-4 text-[10px] md:text-[11px] font-black uppercase tracking-widest transition-all text-rose-500 hover:bg-rose-500/10 rounded-xl group border border-transparent hover:border-rose-500/20`}
      >
