                   ...
                   {[
                     ...
                     return (
                       <div key={docConfig.id} className="bg-white border border-slate-100 p-6 md:p-10 rounded-[32px] md:rounded-[48px] shadow-sm flex flex-col justify-between h-[320px] group transition-all hover:shadow-2xl">
                          ...
                          <div className="mt-8">
                             {uploadedDoc ? (
                               <a href={`${API_URL}${uploadedDoc.file_url}`} target="_blank" rel="noreferrer" className="w-full btn-secondary py-4 text-[9px] uppercase tracking-widest flex items-center justify-center">Retrieve Asset</a>
                             ) : (
