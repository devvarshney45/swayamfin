...
const Login = () => {
  ...
  return (
    <div className={`${isDark ? 'bg-[#020617]' : 'bg-[#F8FAFC]'} min-h-screen flex flex-col items-center justify-start p-6 pt-24 md:pt-36 relative overflow-hidden transition-colors duration-300 font-inter`}>
