...
const Login = () => {
  ...
  return (
    <div className={`${isDark ? 'bg-[#020617]' : 'bg-[#F8FAFC]'} min-h-screen flex items-center justify-center p-6 pt-48 md:pt-64 relative overflow-hidden transition-colors duration-300 font-inter`}>
